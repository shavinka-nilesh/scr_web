...
<div class="container mx-auto p-4 max-w-lg">
    ...
    <form action="{{ route('coaches.update', $coach->id) }}" method="POST" class="bg-white p-6 rounded shadow">
        @csrf
        @method('PUT')
        ...
        <div class="mb-4">
            ...
            <input type="text" name="specialization" id="specialization" value="{{ old('specialization', $coach->specialization) }}" required
                class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" />
        </div>
